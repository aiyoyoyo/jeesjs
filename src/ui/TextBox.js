...
(function () {
	...
	var p = createjs.extend(TextBox, jees.Widget);
	// public method: =========================================================
    /**
     * 获取文本绘制的宽高
     * @method getSize
     ...
     */
	p.getSize = function(){
	    return {w: this._object.getMeasuredWidth() , h: this._object.getMeasuredHeight() }
	};
    /**
     * 设置坐标
     * @method setPosition
	...
	jees.TextBox = createjs.promote( TextBox, "Widget" );
})();